    ...
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="relative flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="https://flowbite.com" className="absolute top-1.5 flex items-center">
            <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
          </a>
          <div className='page-navigation&theme absolute top-1 right-0 w-2/3 flex justify-end gap-3'>
            <div className='page-navigation order-1 lg:order-2 flex flex-col'>
            ...
            absolute flex flex-col justify-between items-center w-full lg:flex lg:w-auto order-2 lg:order-1`}
                id="mobile-menu-2"
              >
